...
const GDVStack = () => {
  return (
    <Stack.Navigator initialRouteName="Home" screenOptions={{ headerShown: false, gestureEnabled: true }} >
      ...
      <Stack.Screen name="NoRechargeCard" component={NoRechargeCardScreen} />
