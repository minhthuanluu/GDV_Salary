...
const NoRechargeCard = (props) => {
    ...
    const [searchData,setSearchData] = useState([
        { "executeDate": "19/07", "phoneNumber": "0383838003", "totalMoney": "90,000", "rechargeDate": "20/07" },
        { "executeDate": "19/07", "phoneNumber": "0483838003", "totalMoney": "90,000", "rechargeDate": "20/07" },
        { "executeDate": "19/07", "phoneNumber": "0483838003", "totalMoney": "90,000", "rechargeDate": "20/07" },
        { "executeDate": "19/07", "phoneNumber": "0483838003", "totalMoney": "90,000", "rechargeDate": "20/07" },
        { "executeDate": "19/07", "phoneNumber": "0483838003", "totalMoney": "90,000", "rechargeDate": "20/07" }
    ])
                        ...
                        return <View>
                            {
                                <View style={{ flexDirection: "row", backgroundColor: index % 2 ? colors.lightGrey : colors.white, paddingVertical: fontScale(8) }}>
                                    ...
                                    <Text style={{ width: width / 4, textAlign: "left", paddingLeft: fontScale(15), fontSize: fontScale(14) }}>{item.phoneNumber}</Text>
