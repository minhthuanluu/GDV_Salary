    ...
    return (
        <SafeAreaView style={{ flex: 1, backgroundColor: colors.primary }}>
            ...
            <ScrollView style={{ flex: 1, backgroundColor: colors.white, }}>
                ...
                <MenuItem width={width-fontScale(20)} style={{marginBottom:fontScale(10)}} noneIcon title="GDV chuyển F-C" titleArray={["GDV","Top"]} data={["1","20 TB/GDV/ngày"]} onPress={()=>navigation.navigate("AdminEmpRegInfo",{"key":"transFc",title:"GDV chuyển F-C","month":month})}/>
                <MenuItem width={width-fontScale(20)} style={{marginBottom:fontScale(10)}} noneIcon title="GDV chuyển F-C ko nạp tiền" titleArray={["","       "]} data={["","20 TB/GDV/ngày"]} onPress={()=>navigation.navigate("AdminEmpRegInfo",{"key":"noRecharge",title:"GDV chuyển F-C ko nạp tiền","month":month})}/>
                <MenuItem width={width-fontScale(20)} style={{marginBottom:fontScale(10)}} noneIcon title="GDV bị chặn user do đấu sai kho số" titleArray={["","       "]} data={["","20 TB/GDV/ngày"]} />
                <MenuItem width={width-fontScale(20)} style={{marginBottom:fontScale(10)}} noneIcon title="GDV xuất hiện >= 3 lần trong 06 tháng" titleArray={["","       "]} data={["","20 TB/GDV/ngày"]} />
            </ScrollView>
        </SafeAreaView>
    );
}
