    ...
    return (
        <SafeAreaView style={{ flex: 1, backgroundColor: colors.primary }}>
            ...
            <View style={styles.body}>
                ...
                <MenuItem style={{ marginTop: fontScale(60) }} title={text.statistical} titleMenuStyle={{ paddingTop: fontScale(17) }} icon={images.growthday} iconStyle={{ width: fontScale(60), height: fontScale(80), marginTop: -fontScale(15) }} width={width - fontScale(60)} onPress={() => checkAdminTransInfoRole()} />
             </View>
