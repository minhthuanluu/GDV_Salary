  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.body}>
        {role == ROLE.VMS_CTY || role == ROLE.ADMIN || role == ROLE.MBF_CHINHANH ? <MenuItem style={{ marginTop: fontScale(30) }} title={text.costManagement} titleMenuStyle={{ paddingTop: fontScale(17) }} icon={images.otherExpenses} width={width - fontScale(60)} onPress={() => navigation.navigate("AdminExpenseManagementDashboard")} /> : null}
        <MenuItem style={{ marginTop: role == ROLE.VMS_CTY || role == ROLE.ADMIN  || role == ROLE.MBF_CHINHANH ?fontScale(60):fontScale(30) }} title={text.topTellers} titleMenuStyle={{ paddingTop: fontScale(17) }} icon={images.toptellers} iconStyle={{ width: fontScale(60), height: fontScale(80), marginTop: -15 }} width={width - fontScale(60)} onPress={() => navigation.navigate("AdminTopTellers")} />
