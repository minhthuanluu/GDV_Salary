            ...
            renderItem={({ item, index }) => (
              ...
              <View>
                <GeneralListItem
                    ...
                    titleArrTwoStyle={{textAlign: "center", fontSize: fontScale(14), fontWeight: "bold", color: "#CC9B02"}}
                    ...
                    // itemAmountFour={[item.rallyCancelAmount,item.rallyFCardAmount,item.rallyBlocking2CAmount,item.rallyFastAmount,item.rallyMDTAmount,item.rallyDebitContactAmount]}
                    // item={[]}
                  title={item.shopName}
                  icon={images.branch}
                   />
